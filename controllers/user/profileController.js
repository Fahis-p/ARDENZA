    ...
    try {
        ...
        if(findUser){
            ...
            if(emailSent){
                ...
                res.render("forgotPass-otp",{user:null})
                console.log("OTP:",otp)
            }else{
    ...
    try {
        ...
        if(user){
            ...
            if(emailSent){
                ...
                req.session.email = email
                res.render("change-password-otp",{user})
                console.log("OTP:",otp)
            }else{
                res.json({success:false,message:"Failed to send OTP,please try again "})
        ...
        console.log("Error in change password validation")
    ...
    try {
        ...
        if(enteredOtp === req.session.userOtp){
         res.json({
            ...
            res.json({success:false,message:"OTP is not matching,please try again "})
        }
